import {
    ...
    USER_UPDATE_FAIL, USER_UPDATE_REQUEST, USER_UPDATE_RESET, USER_UPDATE_SUCCESS
...
export const userListRecuder = (state = {users: []}, action) => {
    switch (action.type) {
...
export const userRecuder = (state = {}, action) => {
    switch (action.type) {
...
export const userRegisterRecuder = (state = {}, action) => {
    switch (action.type) {
